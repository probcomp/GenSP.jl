...
struct CorruptTruncatedUnsafe <: ProxDistribution{String} end
corrupt_truncated_unsafe = CorruptTruncatedUnsafe()

function GenProx.random_weighted(::CorruptTruncatedUnsafe, word)
...
function GenProx.estimate_logpdf(::CorruptTruncatedUnsafe, obs, word, max_len)
