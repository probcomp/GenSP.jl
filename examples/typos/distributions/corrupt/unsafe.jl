...
struct CorruptUnsafe <: ProxDistribution{String} end
corrupt_unsafe = CorruptUnsafe()

function GenProx.random_weighted(::CorruptUnsafe, word)
...
function GenProx.estimate_logpdf(::CorruptUnsafe, obs, word)
